...
<html>
	<head>
		...
		<title>User Data : Presence Management System</title>
	</head>
	...
	<body>
		...
		<ul class="nav nav-tabs topnav">
			...
			<li class="nav-item"><a class="nav-link active" aria-current="page" href="user data.php">User Data</a></li>
		...
		<div class="container">
            ...
            <div class="row">
                <table class="table table-striped table-bordered">
                  <thead>
                    <tr bgcolor="#1E5A3C" color="#1E5A3C">
                      <th>Name</th>
                      <th>ID</th>
					  <th>Gender</th>
					  <th>Email</th>
