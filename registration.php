...
<html>
	<head>
		...
		<title>Registration : Presence Management System</title>
	</head>
	...
	<body>
		...
		<ul class="nav nav-tabs topnav">
			...
			<li class="nav-item"><a class="nav-link active" aria-current="page" href="registration.php">Registration</a></li>
