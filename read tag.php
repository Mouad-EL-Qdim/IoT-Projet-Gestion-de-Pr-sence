...
<html>
	<head>
		...
		<title>Read Tag : Presence Management System</title>
	</head>
	
	<body>
		<h2 align="center">Presence Management System</h2>
		<ul class="nav nav-tabs topnav">
			...
			<li class="nav-item"><a class="nav-link active" aria-current="page" href="read tag.php">Read Tag ID</a></li>
		</ul>
		...
		<div id="show_user_data">
			<form>
				<table  width="452" border="1" bordercolor="#1E5A3C" align="center"  cellpadding="0" cellspacing="1"  bgcolor="#000" style="padding: 2px">
					<tr>
						<td  height="40" align="center"  bgcolor="#1E5A3C"><font  color="#FFFFFF">
							<b>User Data</b>
							</font>
						</td>
					</tr>
